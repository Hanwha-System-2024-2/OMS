...
function createOmqLoginProtocol(user_id, user_pw) {
    console.log('create loginProtocol')
...
module.exports = { createOmqLoginProtocol, parseLoginResponse, parseStockResponse };